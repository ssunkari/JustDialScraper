    ...
    while (page_no < 51):
        ...
        try:
            try:
                driver.find_element_by_xpath(
                    "/html/body/section[15]/section/span[@class='jcl']").click()
            except:
                pass
        ...
        while True:
           # html content from selenium to beautiful soup-------------------->
            ...
            address = (
                soup.find("span", {"class": "adrstxtr"})).text[:-6].strip()
            address = '"'+address+'"'
            ...
            try:
                website = (
                    (soup.findAll("span", {"class": "mreinfp comp-text"})[-1]).find("a"))
            ...
            # print data in excel--------------------->
            f.write('\n'+name.text+","+address+"," +
                    website+","+phone_num+","+verification)
            ...
            try:
                ...
                try:
                    ...
                    pass
                driver.find_element_by_xpath(
                    "//a[@class='dtlpg_sprt cntl_right']").click()
            except:
                page_no = page_no+1
                break
